...
export const GET_GUITARS_BEGIN = "GET_GUITARS_BEGIN";
export const GET_GUITARS_SUCCESS = "GET_GUITARS_SUCCESS";
export const GET_GUITARS_ERROR = "GET_GUITARS_ERROR";
...
export const LOAD_GUITARS = "LOAD_GUITARS";
export const SET_GRIDVIEW = "SET_GRIDVIEW";
export const SET_LISTVIEW = "SET_LISTVIEW";
export const UPDATE_SORT = "UPDATE_SORT";
export const SORT_GUITARS = "SORT_GUITARS";
export const UPDATE_FILTERS = "UPDATE_FILTERS";
export const FILTER_GUITARS = "FILTER_GUITARS";
